package xyz.qinghuan.jobmanage;
...
public class JobManage {
    ...
    public String addJob(AppQuartz appQuartz) throws Exception  {
        ...
        //构建job信息
        if(appQuartz.getJobGroup() != null && !"".equals(appQuartz.getJobGroup())) {
            jobDetail = JobBuilder.newJob((Class<? extends Job>) Class.forName(appQuartz.getJobClassName())).withIdentity(appQuartz.getJobName(), appQuartz.getJobGroup()).build();
        }
